...
const Register = () => {
  ...
  return (
    <div className="min-h-screen bg-chef-light-gray flex flex-col">
      <div className="p-4">
        <Link to="/login" className="flex items-center text-chef-medium-gray">
          <ChevronLeft size={20} />
          <span>Back</span>
        </Link>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-6">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            <h1 className="text-3xl font-bold text-chef-primary mb-2">Create Account</h1>
            <p className="text-chef-medium-gray">Join Chef Sezar and start cooking</p>
          </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 transform -translate-y-1/2 text-chef-medium-gray" size={18} />
                <Input
                  id="fullName"
                  type="text"
                  value={fullName}
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-chef-light-gray text-chef-medium-gray">or sign up with</span>
              </div>
            </div>
          ...
          <p className="mt-8 text-center text-sm text-chef-medium-gray">
            ...
            <Link to="/login" className="font-semibold text-chef-primary hover:underline">
              Sign in
            </Link>
          </p>
        </div>
